...
class CrossrefPaperFetcher:
    ...
    def fetch_papers_async(self, params):
        ...
        try:
            ...
            self.handler.send_event('log', {
                'message': f"Year range: {from_year} to present",
                'level': 'info'
            })
            self.handler.send_event('log', {
            ...
            papers = self.search_papers(keyword, additional_keyword, from_year,
                                      total_results, title_filter, paper_type_filter)
    ...
    def search_papers(self, keyword, additional_keyword, from_year, total_results, title_filter, paper_type_filter):
